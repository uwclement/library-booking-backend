...
public class NotificationService {
    ...
    private NotificationMessage convertToNotificationMessage(Notification notification) {
        ...
        message.setExpirationTime(notification.getExpiresAt().atZone(ZoneId.systemDefault()).toInstant().toEpochMilli());
    ...
    private void maintainMaxNotificationsPerUser(User user) {
        List<Notification> userNotifications = notificationRepository.findByUserEmailOrderByCreatedAtDesc(user.getEmail());
